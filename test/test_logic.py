...
def test_validation_success():
    """Test that valid plans and features return True."""
    is_valid, msg = validate_selection("Basic", ["Personal Training"])
    assert is_valid is True
    assert msg == ""

def test_validation_invalid_plan():
    """Test that a non-existent plan returns False and an error message."""
...
def test_validation_invalid_feature():
    """Test that a non-existent feature returns False and an error message."""
...
def test_special_offer_threshold_200():
    """
    Test special offer threshold:
    Family ($150) + Exclusive Access ($50) = 200.
...
def test_return_integer():
    """Test that the final cost is returned as an integer."""
